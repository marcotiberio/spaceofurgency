...
namespace Flynt\Components\GridPostsEventsLatest;
...
add_filter('Flynt/addComponentData?name=GridPostsEventsLatest', function ($data) {
    $postType = POST_TYPE;
...
{
    return [
        'name' => 'GridPostsEventsLatest',
        'label' => 'Grid: Posts Events Latest',
        'sub_fields' => [
            [
...
Options::addTranslatable('GridPostsEventsLatest', [
    [
