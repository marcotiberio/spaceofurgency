...
namespace Flynt\Components\GridExamplesLatest;
...
add_filter('Flynt/addComponentData?name=GridExamplesLatest', function ($data) {
    $postType = POST_TYPE;
...
{
    return [
        'name' => 'GridExamplesLatest',
        'label' => 'Grid: Examples Latest',
        'sub_fields' => [
            [
...
Options::addTranslatable('GridExamplesLatest', [
    [
