...
namespace Flynt\Components\GridPostsEventsPast;
...
add_filter('Flynt/addComponentData?name=GridPostsEventsPast', function ($data) {
    $postType = POST_TYPE;
...
{
    return [
        'name' => 'GridPostsEventsPast',
        'label' => 'Grid: Events Past',
        'sub_fields' => [
            [
...
Options::addTranslatable('GridPostsEventsPast', [
    [
